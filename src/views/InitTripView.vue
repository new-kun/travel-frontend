<template>
  ...
  <el-dialog v-model="centerDialogVisible" title="旅行計畫" width="500" align-center>
    <el-form :model="form">
        <el-row>
            <el-col>
                <el-form-item label="目的地(英文/中文)">
                    <el-input v-model="form.destination"  maxlength="20" placeholder="日本、Osaka" />
                </el-form-item>
            </el-col>
        </el-row>
  <el-row :gutter="16">
  ...
  <el-row>
    <el-col>
        <el-form-item label="匯率" props="rate">
            <el-input-number v-model="form.rate" :precision="3" :step="0.001" :max="1000" />
        </el-form-item>
    </el-col>
  </el-row>
</el-form>
